...
const { fetchStudents, markAttendence, markDatewise, facultyLogin, getAllSubjects,
...
router.post('/markDatewise', passport.authenticate('jwt', { session: false }), markDatewise) 
