...
const { checkAttendence, getAllStudents, getStudentByName, studentLogin,
    ...
    previousChats, updateProfile, getAllSubjects, getMarks, datewiseAttendence } = require('../controller/studentController')
...
router.get('/datewiseAttendance', passport.authenticate('jwt', { session: false }), datewiseAttendence)
